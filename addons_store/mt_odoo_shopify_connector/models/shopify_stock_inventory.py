...
# Note: stock.change.product.qty wizard was removed in Odoo 19
# Stock quantity adjustments are now handled directly through stock.quant model
# The logic for updating shopify_product_free_qty is handled in the write method above