...

{
    ...
    'assets': {
        'web.assets_backend': [
            # 'mt_odoo_shopify_connector/static/src/scss/shopify_graph_widget.scss',  # Commented out: dashboard widget
            # 'mt_odoo_shopify_connector/static/src/**/*.js',  # Commented out: dashboard widget JS
            # 'mt_odoo_shopify_connector/static/src/**/*.xml',  # Commented out: dashboard widget XML
            'mt_odoo_shopify_connector/static/src/js/kanban_view_import_button.js',
            'mt_odoo_shopify_connector/static/src/js/tree_view_import_button.js',
            'mt_odoo_shopify_connector/static/src/xml/kanban_view_button.xml',
            'mt_odoo_shopify_connector/static/src/xml/tree_view_button.xml',
        ],
    },    
}
