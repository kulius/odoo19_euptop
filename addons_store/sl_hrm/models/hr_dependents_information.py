...
class HrDependentsInformation(models.Model):
    ...
    health_rate = fields.Selection([('1', '無補助'), ('0.75', '補助1/4'), ('0.5', '補助1/2'), ('0', '免繳')],
                                   string='政府補助健保費', required=True)
    identification_card = fields.Char(string='身分證')
    date_of_birth = fields.Date(string='生日')
    add_insurance_time = fields.Date(string='加保時間', required=True)
        ...
        for i in self:
            if i.identification_card:
                if not re.match(r'^[A-Z][1-2]\d{8}$', i.identification_card):
                    ...
                    region_mapping = {'A': '10', 'B': '11', 'C': '12', 'D': '13', 'E': '14', 'F': '15', 'G': '16',
                                      'H': '17',
                                      'I': '34', 'J': '18', 'K': '19', 'L': '20', 'M': '21', 'N': '22', 'O': '35',
                                      'P': '23',
                                      'Q': '24', 'R': '25', 'S': '26', 'T': '27', 'U': '28', 'V': '29', 'W': '32',
                                      'X': '30',
                                      'Y': '31', 'Z': '33'}
