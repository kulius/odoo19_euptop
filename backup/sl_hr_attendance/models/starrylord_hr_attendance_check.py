...
class HrAttendanceCheck(models.Model):
    ...
    def create_attendance(self, date_start=None):
        ...
        # 取得action
        action = self.env.ref('sl_hr_attendance.hr_attendance_check_manager_action').read()[0]
...
<div style="font-family: Arial, sans-serif; max-width: 900px; margin: 0 auto; padding: 20px;">
    ...
    <div style="margin-top: 30px; text-align: center; padding: 20px; background-color: #f8f9fa; border-radius: 5px;">
        <a href="{base_url}/web#action=sl_hr_attendance.hr_attendance_check_manager_action&view_type=list" 
...
<div style="font-family: Arial, sans-serif; max-width: 700px; margin: 0 auto; padding: 20px;">
    ...
    <div style="margin-top: 30px; text-align: center; padding: 20px; background-color: #f8f9fa; border-radius: 5px;">
        <a href="{base_url}/web#action=sl_hr_attendance.hr_attendance_check_action&view_type=list" 
        ...
        <a href="{base_url}/web#action=sl_hr_attendance.action_sl_attendance_repair&view_type=form" 
